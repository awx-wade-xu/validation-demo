...
import { IForm, IField } from '@/types';
...
export const SimpleForm: FC<IProps> = memo(({ formData, refetch }) => {
  ...
  useMemo(() => {
    let data: any = {};
    formData.fields.forEach(field => (data[field.key] = field.defaultValue));
  ...
  const onValuesChange = useCallback(
    (changedValues, values) => {
      ...
      formData.fields.forEach(innerField => {
